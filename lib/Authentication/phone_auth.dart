                    ...
                    Expanded(
                      child: TextFormField(
                        ...
                        inputFormatters: [
                          ...
                          LengthLimitingTextInputFormatter(10), // Max 10 digits for Indian numbers
                        ],
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                            return 'Phone number is required';
                    ...
                    onPressed: () async {
                      if (_formKey.currentState!.validate()) {
                        ...
                        if (countryController.text == '+91' && !isValidIndianNumber(formattedPhoneNumber)) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text('Please enter a valid Indian mobile number (10 digits starting with 6-9)'),
                              margin: EdgeInsets.all(16),
                              behavior: SnackBarBehavior.floating,
                              backgroundColor: Colors.red,
                            ),
