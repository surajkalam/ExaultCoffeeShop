...
//                   ),
//                 ),
//                 children: [FQAcontainer(height, width)],
//               ),
//               ExpansionTile(
//                 title: Text(
//                   "Contact Support",
...
//                   ),
//                 ),
//                 children: [ordersupport(height, width)],
//               ),
//               ExpansionTile(
//                 title: Text(
//                   "Store Information",
...
//                   ),
//                 ),
//                 children: [storeinfo(context, height, width, '9657546519')],
//               ),
//               ExpansionTile(
//                 title: Text(
//                   "Feedback Suggestion",
...
//                   ),
//                 ),
//                 children: [feedbacksuggestion(height, width)],
//               ),
//             ],
//           ),
//         ),
...
//   Widget feedbacksuggestion(double height, double width) {
...
//           SizedBox(height: height * 0.01),
//           Text(
//             "-Do you have gluten-free and dairy-free options?",
//             style: TextStyle(
//               fontWeight: FontWeight.bold,
//               fontSize: width * 0.04,
//               color: Colorclass.blackcolor,
...
//                       borderRadius: BorderRadius.circular(width * 0.02),
//                       child: Image(
//                         image: AssetImage("Assets/Icons/exault.jpg"),
//                         height: height * 0.05,
//                         width: width * 0.1,
//                         fit: BoxFit.fill,
//                       ),
...
//                       borderRadius: BorderRadius.circular(width * 0.02),
//                       child: Image(
//                         image: AssetImage("Assets/Icons/whattapp.jpg"),
//                         height: height * 0.05,
//                         width: width * 0.1,
//                         fit: BoxFit.fill,
//                       ),
...
//   Widget ordersupport(double height, double width) {
//     return Padding(
//       padding: EdgeInsets.symmetric(
...
//           Row(
//             children: [
//               containerwidget('missing item'),
//               SizedBox(width: width * 0.02),
//               containerwidget('Order not received / delayed'),
//             ],
//           ),
//           SizedBox(height: height * 0.01),
//           Row(
//             children: [
//               containerwidget('Wrong item delivered'),
//               SizedBox(width: width * 0.02),
//               containerwidget('Change delivery address or pickup time'),
//             ],
//           ),
//           SizedBox(height: height * 0.01),
...
//           Row(
//             children: [
//               containerwidget('Payment issues'),
//               SizedBox(width: width * 0.02),
//               containerwidget('Order cancellation / refund'),
//             ],
//           ),
//         ],
//       ),
          ...
          child: Column(
            children: [
              ...
              _buildExpansionTile(
                ...
                icon: Icons.store,
                child: storeinfo(context, height, width, '9657546519'),
                isIOS: isIOS,
              ),
              SizedBox(height: height * 0.02),
              _buildExpansionTile(
...
// Keep all your existing _makePhoneCall, _launchWhatsApp, _launchInstagram,
// _launchWebsite methods exactly as they were}
