...
// class Newarraivles extends StatefulWidget {
//   const Newarraivles({super.key});

//   @override
//   State<Newarraivles> createState() => _NewarraivlesState();
// }

// class _NewarraivlesState extends State<Newarraivles> {
...
//       String fileName =
//           'items/newarravials/image_${DateTime.now().millisecondsSinceEpoch}.jpg';
...
class _NewArrivalsState extends State<NewArrivals> {
  ...
  Future<void> _uploadImageToFirebase() async {
    ...
    try {
      final storageRef = FirebaseStorage.instance.ref();
      String fileName = 'items/newarrivals/image_${DateTime.now().millisecondsSinceEpoch}.jpg';
      final imageRef = storageRef.child(fileName);
